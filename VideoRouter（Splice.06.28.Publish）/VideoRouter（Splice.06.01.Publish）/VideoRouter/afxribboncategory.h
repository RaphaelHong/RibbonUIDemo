...
public:
	...
	CMFCRibbonPanel* AddPanel(int nInsertAt, LPCTSTR lpszPanelName, HICON hIcon = 0, CRuntimeClass* pRTI = NULL)
	{
		ASSERT_VALID(this);
	...
	void RemovePanel(CMFCRibbonPanel *pPanel)
	{
		ASSERT(pPanel);
