...
void CSourcePropertyDlg::OnBtnDefaultBrightnessContrast()
{
	...
	if (GetCmdManager()->CmdRST2(m_nSourcePort, eBoardTypeInput, m_nLightness, m_nContrast) == CMD_FAILURE)
	{
...
void CSourcePropertyDlg::OnBtnDetectBrightnessContrast()
{
	...
	if (GetCmdManager()->CmdRPM2(m_nSourcePort, eBoardTypeInput, m_nLightness, m_nContrast) == CMD_FAILURE)
	{
		MessageBox(_T("读取亮度/对比度失败！"), _T("默认亮度/对比度"), MB_OK|MB_ICONERROR);
		return;
	}
...
void CSourcePropertyDlg::OnBtnApplyBrightnessContrast()
{
	...
	if (GetCmdManager()->CmdWPM2(m_nSourcePort, eBoardTypeInput, m_nLightness, m_nContrast) == CMD_FAILURE)
	{
...
void CSourcePropertyDlg::OnBtnDefaultSample()
{
	...
	if (GetCmdManager()->CmdRST1(m_nSourcePort, eBoardTypeInput, m_nLeft, m_nTop, m_nWidth, m_nHeight) == CMD_FAILURE)
	{
...
void CSourcePropertyDlg::OnBtnAutoSample()
{
	...
	if (GetCmdManager()->CmdATO1(m_nSourcePort, eBoardTypeInput, m_nLeft, m_nTop, m_nWidth, m_nHeight) == CMD_FAILURE)
	{
...
void CSourcePropertyDlg::OnBtnDetectSample()
{
	...
	if (GetCmdManager()->CmdRPM1(m_nSourcePort, eBoardTypeInput, m_nLeft, m_nTop, m_nWidth, m_nHeight) == CMD_FAILURE)
	{
...
void CSourcePropertyDlg::OnBtnApplySample()
{
	...
	if (GetCmdManager()->CmdWPM1(m_nSourcePort, eBoardTypeInput, m_nLeft, m_nTop, m_nWidth, m_nHeight) == CMD_FAILURE)
	{
...
void CSourcePropertyDlg::OnBtnSetColorspace()
{
	...
	if (GetCmdManager()->CmdWICS(m_nSourcePort, eBoardTypeInput, nMode) == CMD_FAILURE)
	{
...
void CSourcePropertyDlg::OnSliderLBtnUp(CMySliderCtrl* pSlider)
{
	...
	{
		GetCmdManager()->CmdWPM2(m_nSourcePort, eBoardTypeInput, m_nLightness, m_nContrast);
	}
	else if (pSlider == &m_sliderContrast
	...
	{
		GetCmdManager()->CmdWPM1(m_nSourcePort, eBoardTypeInput, m_nLeft, m_nTop, m_nWidth, m_nHeight);
	}
}
