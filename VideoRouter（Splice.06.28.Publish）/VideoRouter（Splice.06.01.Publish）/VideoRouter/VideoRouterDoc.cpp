...
// VedioRouterDoc.cpp : CVideoRouterDoc 类的实现
//
...
BEGIN_MESSAGE_MAP(CVideoRouterDoc, CDocument)
	...
	ON_COMMAND(ID_FILE_SAVE_AS, &CVideoRouterDoc::OnFileSaveAs)
...
BOOL CVideoRouterDoc::OnSaveDocument(LPCTSTR lpszPathName)
{
