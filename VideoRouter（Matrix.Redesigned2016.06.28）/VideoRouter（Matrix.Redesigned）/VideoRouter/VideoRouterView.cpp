...
int CVideoRouterView::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
	...
	//AddView(RUNTIME_CLASS(CSwitchPanelView), _T("快速切换器"), 0);
	//AddView(RUNTIME_CLASS(CSwitchPanelView), _T("Panel Model"), 1);
	//AddView(RUNTIME_CLASS(CFlowGraphView), _T("Flow Graph"), 1);
